...
<li class="list-group-item" style="padding: 0px;">
    <div class="col-md-3" style="padding: 0px;">
        <div style="text-align: center;padding: 10px;height: 100%">
            ...
            <img src="<?php 
            if ($_SESSION["M_id"]!=""){
$M_pic=getrs("select * from ".TABLE."member where M_id=".$_SESSION["M_id"],"M_pic");
if(substr($M_pic,0,4)!=="http"){
$M_pic="../media/".$M_pic;
}
            echo $M_pic;
...
<iframe src="../conn/code_1.php?name=code" scrolling="no" frameborder="0" width="300" height="40" style="vertical-align:top;margin-top:10px;"></iframe>
