<?php 
define('SCMS_ROOT', substr(dirname(__FILE__),0,-6));
require SCMS_ROOT.'conn/conn2.php';
require SCMS_ROOT.'conn/function.php';
...
<div class="form-group" style="padding: 10px 0;">
          ...
          <?php if ($C_qqkj==1){?>
            ...
            <?php }?>
            <?php if ($C_wxkj==1){?>
            <a href="<?php if (wapstr()){ echo gethttp().$C_domain?><?php echo $C_dir?>wxpay/login.php?genkey=<?php echo $genkey?><?php }else{?>javascript:;<?php }?>" <?php if (!wapstr()){?>data-toggle="tooltip" <?php }?>title="<div style='text-align:center;padding:10px;'><img src='https://static.websiteonline.cn/website/qr/index.php?url=<?php echo gethttp().$C_domain?><?php echo $C_dir?>wxpay/login.php?genkey=<?php echo $genkey?>' width='150'></div>" class="btn btn-xs btn-success"><i class="fa fa-wechat"></i> <?php echo lang("微信登录/l/Wechat")?></a>
            <?php }?>
            <div class="pull-right">
