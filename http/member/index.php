...
<?php require 'top.php';?>
		...
		$sql="select * from ".TABLE."orders,".TABLE."product,".TABLE."lv,".TABLE."member where M_lv=L_id and O_member=M_id and O_pid=P_id and O_member=".$M_id." group by O_no order by O_id desc limit 3";
		$result = mysqli_query($conn, $sql);
		if (mysqli_num_rows($result) > 0) {
